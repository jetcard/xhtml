 ...
 * @author HH38092
 */
public class CobCronogramaMetaDetalle extends Base{
    ...
    private int total_asesor;
    private int total_llamada;
   ...
   /**
    ...
    public double getI_ica_atrasado() {
        return i_ica_atrasado;
    }

    public void setI_ica_atrasado(double i_ica_atrasado) {
        this.i_ica_atrasado = i_ica_atrasado;
    }
    ...
    /**
     * @return the total_asesor
     */
    public int getTotal_asesor() {
        return total_asesor;
    }

    /**
     * @param total_asesor the total_asesor to set
     */
    public void setTotal_asesor(int total_asesor) {
        this.total_asesor = total_asesor;
    }

    /**
     * @return the total_llamada
     */
    public int getTotal_llamada() {
        return total_llamada;
    }

    /**
     * @param total_llamada the total_llamada to set
     */
    public void setTotal_llamada(int total_llamada) {
        this.total_llamada = total_llamada;
    }

    /**
     * @return the porcentaje_cumplimiento
     */
    ...
    /**
     * @param porcentaje_cumplimiento the porcentaje_cumplimiento to set
     */
