...
public class HeaderFooter extends PdfPageEventHelper {
    ...
    public static final String HEADER = "<table width=\"100%\" border=\"1\"><tr>"
            + "<td>Header </td>"
            + "<td align=\"left\">Some title</td></tr></table>";
    public static final String FOOTER = "<table width=\"100%\" border=\"1\"><tr><td>Footer</td><td align=\"right\">Some title</td></tr></table>";
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        try {
            ...
            Element eImg = jpg;
            //jpg.scaleAbsoluteHeight(90);
            jpg.scaleAbsoluteHeight(30);
            jpg.scaleAbsoluteWidth(150);
            //ct.setSimpleColumn(new Rectangle(36, 740, 200, 810));
            ct.setSimpleColumn(new Rectangle(0, 740, 100, 810));
            ct.addElement(eImg);
            ct.go();
            // text www 
            ...
            Rectangle rect3 = new Rectangle(150, 785, 700, 810);
            ...
            headerTable.writeSelectedRows(0, -1, 30, 750, writer.getDirectContent());
            // pie azul
