...
public interface ILegalServ {
    ...
    List<MaeEstadoLegal> listarEstadoTchnLegal(String idEstado) throws Exception;
    ...
    List<LegalTchn> listarSeguidores(LegalTchn oLegalTchn) throws Exception;
    ...
    List<LegalAsesor> listaAsesores(LegalAsesor oLegalAsesor) throws Exception;
    ...
    List<LegSgtoOtroProceso> listarSeguimientosOtros(LegSgtoOtroProceso oLegSgtoOtroProceso) throws Exception;
    ...
    List<LegSgtoOtroProceso> consultaSeguimientosOtros(LegSgtoOtroProceso oLegSgtoOtroProceso) throws Exception ;
}
