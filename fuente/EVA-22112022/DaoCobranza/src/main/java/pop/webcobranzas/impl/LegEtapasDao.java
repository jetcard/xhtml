 ...
 * @author HH38092
 */
public class LegEtapasDao  extends DBUtil implements ILegEtapasDao {
    ...
    public LegEtapasDao(OracleConnection cnx) {
        cn = cnx;
    }
    
    @Override
    public ArrayList<LegEtapa> fetchAll() {
        ArrayList<LegEtapa> lstEtapa = new ArrayList<>();
        ...
        try {
            ...
            oList = listParameters("0001");//0001: ETAPAS
            ...
            while (resultSet.next()) {
                LegEtapa newEtapa = new LegEtapa();
                newEtapa.setCEtapaId(resultSet.getString("C_TABLA_DET_ID"));
                newEtapa.setDEtapa(resultSet.getString("D_DESCRIPCION"));
                
                lstEtapa.add(newEtapa);
            }
        } catch (Exception e) {
