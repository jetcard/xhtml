 ...
 * @author HH38092
 */
public class LegTablasDao extends DBUtil implements ILegTablasDao {
    ...
    public LegTablasDao(OracleConnection cnx) {
        cn = cnx;
    }
    
    @Override
    public ArrayList<LegTabla> fetchAll(String tabla) {
