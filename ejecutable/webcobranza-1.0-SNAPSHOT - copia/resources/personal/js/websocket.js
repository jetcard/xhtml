...
var socket = new WebSocket("ws://localhost:8686/webcobranza/notificacion/" + document.getElementById("usernamePost").innerHTML.trim());
...
//    document.body.appendChild(dvscript);
    ...
    if (notificacion.tipo == "0001") {
        ...
        scriptElement.innerText = 'var options = {body: \'' + notificacion.cuerpo + '\',icon: \'http://localhost:8686/webcobranza/resources/personal/img/alarm.png\'}; var notification = new Notification(\'' + notificacion.titulo + '\', options);';
